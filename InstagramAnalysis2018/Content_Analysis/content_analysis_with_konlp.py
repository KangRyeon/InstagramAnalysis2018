# content_analysis_with_konlp.py
# CONTENT 형태소 뽑아내기 완료
...
def tokenize(doc, token):
  return [token.join(t) for t in twitter.pos(doc, norm=True, stem=True)] # norm, stem은 optional
...
# 형태소 분류(문장에서 낱말뽑아냄.)
number = [170,174,180,182,183,184,192,200] #number = [0,8,9,16,24,32,40,48,56,64,66,68,72,80,87,88,90,96,104,112,120,128,136,144,152,160,168,170,174,180,182,183,184,192,200]
print(len(number))
